...
E Chi, G Allen, **H Zhou**, O Kohannim, K Lange, and P Thompson. (2013) New developments in sparse canonical correlation analysis for imaging genetics studies, [_Information Processing in Medical Imaging_](http://ieeexplore.ieee.org.prox.lib.ncsu.edu/xpl/login.jsp?reload=true&tp=&arnumber=6556581&url=http%3A%2F%2Fieeexplore.ieee.org%2Fxpls%2Fabs_all.jsp%3Farnumber%3D6556581), accepted. \[[pdf](./media/pdf/Chi13TensorCCA.pdf)]  
...
K Lange and **H Zhou**. (2012) MM algorithms for geometric and signomial programming, [_Mathematical Programming Series A_][8], in press. \[[pdf](./media/pdf/LangeZhou12GP.pdf)\]  
