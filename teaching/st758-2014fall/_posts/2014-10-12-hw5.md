...
Homework 5 is posted on the [schedule](../../../../schedule.html) page. It is due Tue Oct 21 in class.
...
* email code (only) to me <hua_zhou@ncsu.edu> with subject `ST758 HW5` and file name `LastFirstHW5.r`  
