...
The `LA_Parking_Citations.csv` file contains information about parking tickets in LA City. It is downloaded from [LA Open Data Portal](https://data.lacity.org/A-Well-Run-City/Parking-Citations/wjz9-h9np). 
...
Import the `lapktk` data set into the SQLite database:
```{r}
library("DBI")
library("RSQLite")
library("tidyverse")
