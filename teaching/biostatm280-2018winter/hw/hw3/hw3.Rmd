...
Make a Shiny app to facilitate exploration of this data set. For efficiency, you should first preprocess, shrink, and tidy the data to be used in the app.
