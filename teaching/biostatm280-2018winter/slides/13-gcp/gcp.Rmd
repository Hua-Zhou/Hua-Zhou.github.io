...
## Cloud computing isn't in cloud
...
- You can install Linux dependencies `curl`, `openssl`, and `libxml2` by:
```{bash, eval = FALSE}
...
- Launching cluster instances is easy.

- Heavily customized instances (SQL server, BigQuery, ML engine, Genomics, ...).
