...
- Statisticians write a lot of code. Critical to adopt a good IDE (integrated development environment) that goes beyond code editing: syntax highlighting, executing code within editor, debugging, profiling, version control, etc.
...
- Seamless use of many services: Git, svn, Amazon EC2 cloud service, parallel computing on multiple hosts in Julia, ...
...
<p align="center">
  <img src="./key_authentication.png" height="400">
</p>
