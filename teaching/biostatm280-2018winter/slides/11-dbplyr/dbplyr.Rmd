...
if (Sys.info()[["sysname"]] == "Darwin") {
  csvfile = "./NYParkingViolations.csv"
} else if ((Sys.info()[["sysname"]] == "Linux")) {
  csvfile = "/home/m280-data/nyc_parking/NYParkingViolations.csv"
}
```
...
- The `/home/m280-data/nyc_parking/NYParkingViolations.csv` file on teaching server contains information about parking tickets in NYC. You can make a symbolic link to the data file by Bash command
```{bash, eval = (Sys.info()[["sysname"]] == "Linux")}
ln -s /home/m280-data/nyc_parking/NYParkingViolations.csv NYParkingViolations.csv
```
...
- Install database drivers: <https://db.rstudio.com/best-practices/drivers/>.
...
`nyc_sql` was 30x times faster than `nyc`, but the former is disk based while the latter is in memory.
