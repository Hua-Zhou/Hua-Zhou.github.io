...
# Combine tables | combine variables (columns)

## 

nycflights13 has 5 tables:
...
# Combine tables | combine cases (rows)
...
- `bind_rows()` stacks tables one on top of the other as a single table. 
    ```{r}
    bind_rows(df1, df2)
    ```
