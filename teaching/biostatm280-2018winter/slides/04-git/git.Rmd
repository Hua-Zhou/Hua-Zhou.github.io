...
- A **Git server** enabling multi-person collaboration through a centralized repository.
    ...
    - [github.com](github.com): unlimited public repositories, private repositories costs $, unlimited private repositories for free from [Student Developer Pack](https://education.github.com/pack).
...
- For this course, you need to have two branches:
    ...
    - `master` for releases (homework submission). 
